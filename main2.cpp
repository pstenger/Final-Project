...
int LButton::handleEvent( SDL_Event* e, int i )
{
	...
	if( e->type == SDL_MOUSEMOTION || e->type == SDL_MOUSEBUTTONDOWN || e->type == SDL_MOUSEBUTTONUP )
	{
		...
		//Mouse is inside button
	        else if (e->type ==SDL_MOUSEBUTTONDOWN && i == 0) {
		  	mCurrentSprite = mariohd;
			return(1);
		} else if (e->type ==SDL_MOUSEBUTTONDOWN && (i == 2)) {
		  mCurrentSprite = linkhd;
		  return(2);
		} else if (e->type ==SDL_MOUSEBUTTONDOWN && (i == 4)) {
		  mCurrentSprite = pachd;
		  return(3);
		} else if (e->type ==SDL_MOUSEBUTTONDOWN && (i == 6)) {
		  mCurrentSprite = megahd;
		  return(4);
		}
		else if (e->type ==SDL_MOUSEBUTTONDOWN && i == 1) {
		  	mCurrentSprite = mariohd;
			return(5);
		} else if (e->type ==SDL_MOUSEBUTTONDOWN && ( i==3)) {
		  mCurrentSprite = linkhd;
		  return(6);
		} else if (e->type ==SDL_MOUSEBUTTONDOWN && (i==5)) {
		  mCurrentSprite = pachd;
		  return(7);
		} else if (e->type ==SDL_MOUSEBUTTONDOWN && (i==7)) {
		  mCurrentSprite = megahd;
		  return(8);
		}
